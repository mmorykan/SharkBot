...
class HelpInfo:
    ...
    async def helper(cls, message):
        ...
        # embed.add_field(name='$pumkinhed', value='Displays a message about Pumkinhed', inline=False)
        embed.add_field(name='$info', value='Displays information about Sharkbot', inline=False)
        embed.add_field(name='$help', value='Displays all availabel SharkBot commands', inline=False)
